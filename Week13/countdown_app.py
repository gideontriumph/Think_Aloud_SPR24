"""
    Name: countdown_app.py
    Author: Triumph Ogbonnia
    Created: 4/11/24
    Purpose: Countdown app using tkinter
"""
from tkinter import *
...
class Application(Frame):
    ...
    def createWidgets(self):
        ...
        self.closeButton = Button(self.someFrame, text="Exit", font=('Helvetica',12), bg='red',fg='white', command=self.closeApp)
...
if __name__ == '__main__':
    root = Tk()
    root.iconbitmap("./Week13/timer.ico")
